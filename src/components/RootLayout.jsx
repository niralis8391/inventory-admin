...
export const RootLayout = () => {
    ...
    return (
        <div>
            <Navbar />
            <div className='flex'>
                <div className={`max-md:w-xs max-md:h-full max-md:absolute max-md:-left-hull ${menu ? 'left-0' : '-left-full'} transition-all duration-300 ease-in-out bg-white z-50  md:w-sm `}>
                    <div className='block md:hidden'>
                        {!menu && <button className='fixed z-60 top-24 left-5 p-1 rounded-md border bg-white' onClick={() => setMenu(true)}>
